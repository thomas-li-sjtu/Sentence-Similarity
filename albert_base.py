...
parser.add_argument('--pretrained_model_dir', type=str, help='预训练模型地址', default='./pretrained_model/albert-base-v2')
...
parser.add_argument('--output_model_dir', type=str, help='模型保存地址', default='./albert-finetune')
...
vocab_file_dir = './pretrained_model/albert-base-v2'
